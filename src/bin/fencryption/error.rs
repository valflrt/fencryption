...
use fencryption_lib::{crypto, metadata};
...
pub enum ErrorKind {
    ...
    EncryptMetadata(crypto::ErrorKind),
    DecryptMetadata(crypto::ErrorKind),
    ...
    EncryptText(crypto::ErrorKind),
    DecryptText(crypto::ErrorKind),

    AesEncryptFile(aes_gcm::Error),
    AesDecryptFile(aes_gcm::Error),
